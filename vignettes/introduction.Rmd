...
date: 'Last modified: 2016-06-06; Generated on `r Sys.Date()`'
...
For Bioconductor workflows, the package also includes a function to convert `WideSomaLogicData` objects into [*Biobase*](https://www.bioconductor.org/packages/release/bioc/html/Biobase.html) `ExpressionSet`s.
